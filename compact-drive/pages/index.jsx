  ...
  const [galleryImages, setGalleryImages] = useState([
    {
      ...
      exam_date: "Se încarcă..."
    }
  ]);

  // Fetch images from Supabase - SIMPLU
  useEffect(() => {
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "image": [
              ...
              "https://compactdrive.ro/bmw1.jpeg",
              "https://compactdrive.ro/camion.jpeg"
            ],
...
Școala de șoferi Compact Drive este recunoscută ca una dintre cele mai bune și mai apreciate școli de șoferi din municipiul Roman, unde seriozitatea și profesionalismul te pregătesc pentru succes.Începe drumul către permisul tău astăzi!
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            {/* Container foarte îngust pentru poze verticale de telefon - max-w-xl pe desktop */}
      ...
      {/* REST OF SECTIONS - keeping them identical */}
