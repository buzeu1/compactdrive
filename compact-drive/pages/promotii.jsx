          ...
          {loading ? (
            <div className="min-h-[400px] bg-white rounded-2xl shadow-xl p-8 md:p-12 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-lg">Se incarca promotiile...</p>
              </div>
            </div>
          ) : promotions.length === 0 ? (
            <div className="min-h-[400px] bg-white rounded-2xl shadow-xl p-8 md:p-12 flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-3">
                  Nicio promotie activa momentan
                </h3>
                <p className="text-gray-600 text-lg mb-2">
                  Revino curand pentru oferte speciale!
                </p>
                <p className="text-gray-500 text-sm">
                  Urmareste-ne pe retelele sociale pentru a fi la curent cu reducerile
                </p>
              </div>
            </div>
          ) : (
                    ...
                    {promo.valid_until && (
                      <div className="flex items-center space-x-2 text-gray-600 mb-6 bg-gray-100 px-4 py-3 rounded-lg">
                        ...
                        <span className="font-semibold">
                          Valabil pana la: {promo.valid_until}
                        </span>
                      </div>
                    )}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Exploreaza ofertele noastre
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Descopera toate autovehiculele si serviciile disponibile
            </p>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Formam soferi responsabili, pentru un trafic bazat pe respect si siguranta.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <div className="font-semibold">Pietonal Stefan cel Mare, Roman 611038</div>
          ...
          <div>
            ...
            <div className="rounded-lg overflow-hidden h-48">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2725.0461041495614!2d26.922959276189733!3d46.92147547113519!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40caa3eed6e33e05%3A0x121539b93879e5d4!2sCompact%20Drive%20Roman!5e0!3m2!1sro!2sro!4v1771632562778!5m2!1sro!2sro"
                width="100%" 
                height="100%" 
                style={{ border: 0 }}
                allowFullScreen="" 
